...
import { FiSearch, FiSend, FiPaperclip, FiImage, FiSmile, FiMic, FiUser, FiVideo, FiPhone } from 'react-icons/fi';
  ...
  return (
    <div className="relative pt-20 pb-16 min-h-screen">
      ...
      <div className="container mx-auto px-4 py-0">
        <div className="bg-white/80 dark:bg-gray-900/80 backdrop-blur-md rounded-xl shadow-xl overflow-hidden border border-gray-200 dark:border-gray-800 h-[calc(100vh-4rem)]">
          <div className="flex h-full">
            {/* Sidebar des conversations */}
            <div className="w-full max-w-xs border-r border-gray-200 dark:border-gray-800 flex flex-col">
                ...
                <AnimatePresence>
                  {filteredConversations.map((conversation) => (
                    <motion.div
                      ...
                      onClick={() => setActiveContact(conversation.id)}
                    >
